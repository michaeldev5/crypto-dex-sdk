...
import { Checker, useStableSwapWithBase, Web3Input } from '@crypto-dex-sdk/compat'
...
import { Button, classNames, Dots, Skeleton, Tooltip, Typography, Widget } from '@crypto-dex-sdk/ui'
