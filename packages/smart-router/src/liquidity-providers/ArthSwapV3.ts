...
import { ArthswapV3PoolCode, UniV3Pool } from '../entities'
...
export class ArthSwapV3Provider extends LiquidityProvider {
  ...
  public readonly factory: { [chainId: number]: Address } = {
    [ParachainId.ASTAR]: '0x69E92b56e4BF4C0FFa2cFB087c7EA47E846a7244',
  }
  ...
  public async getPools(tokens: Token[]) {
    ...
    pools.forEach((pool, i) => {
      ...
      const pc = new ArthswapV3PoolCode(v3pool, this.getPoolProviderName())
  ...
  public getType(): LiquidityProviders {
    return LiquidityProviders.ArthSwapV3
  }
