import { type AggregatorTrade, TradeVersion, calculateSlippageAmount } from '@crypto-dex-sdk/amm'
...
import { type JSBI, MAX_UINT256, Percent, ZERO } from '@crypto-dex-sdk/math'
